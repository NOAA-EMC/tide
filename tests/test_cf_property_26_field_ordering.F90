!> @file test_cf_property_26_field_ordering.F90
...
program test_cf_property_26_field_ordering
  use ESMF
  use pio
  use tide_output_mod
  ...
  do iter = 1, NUM_ITERATIONS
    ...
    ! -----------------------------------------------------------------
    write(out_file, '(a,i0,a)') "test_field_ordering_", iter, ".nc"
    ...
    ! (e) Finalize to flush and close the file before reading back
...
contains
  ...
  !> Produces names like "fld_03_i042_s1234" to ensure uniqueness within a pool.
...
end program test_cf_property_26_field_ordering
